	...
	\IPS\Content\MetaData
{
	 ...
	 */
	static protected $recordCommentPageCount = NULL;
	...
	{
		if ( static::$recordCommentPageCount === NULL or $recache === TRUE )
		{
			if ( $this->useForumComments() )
			{
				try
				{
					...
					if( $topic !== NULL )
					{
						...
						static::$recordCommentPageCount = $topic->commentPageCount( $recache );
					}
					else
					{
						static::$recordCommentPageCount = 0;
					}
				}
				catch( \Exception $e ) { }
			}
			...
			{
				static::$recordCommentPageCount = parent::commentPageCount( $recache );
			}
		}
		
		return static::$recordCommentPageCount;
	}
